# floor-plan-simulation-visual Specification

## Purpose
Defines how FloorPlanView displays simulation state — room power indicators, wiring path color transitions, current flow animations, and old house problem badges.
